...
const inputClass =
  'w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-4 text-2xl font-bold text-slate-900 outline-none ring-brand-500 focus:border-brand-500 focus:bg-white focus:ring-2 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100 dark:focus:bg-slate-800'
      ...
      <div className="fixed inset-0 z-[60] flex items-end justify-center sm:items-center">
        ...
        <div className="mb-4 flex items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">{nombre}</p>
            <p className="text-sm text-slate-500 dark:text-slate-400">Talla {talla}</p>
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl hover:bg-slate-100 active:scale-95 dark:hover:bg-slate-800"
            aria-label="Cerrar"
          >
            <X className="h-5 w-5" />
          </button>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <label className="block">
            <span className="mb-2 block text-sm font-semibold text-slate-600 dark:text-slate-400">
              Precio unitario
            </span>
            <input
              type="number"
          ...
          <button
            ...
            className={cn(
              ...
              valido
                ? 'bg-[#D48C70] text-white hover:bg-[#C27A5F]'
